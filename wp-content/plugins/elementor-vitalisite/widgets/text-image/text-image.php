<?php
class Elementor_Text_Image extends \Elementor\Widget_Base
{
    ...
    {
        return esc_html__('Texte avec image', 'elementor-addon');
    }
    ...
    protected function register_controls(): void
    {
        ...
        $this->start_controls_section(
            'section_title',
            [   'label' => esc_html__('Texte avec image', 'elementor-addon'),
        ...
        $this->add_control(
            'way',
            [
                'label' => esc_html__('Image à droite ?', 'textdomain'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Oui', 'textdomain'),
                'label_off' => esc_html__('Non', 'textdomain'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('En savoir plus', 'textdomain'),
                'placeholder' => esc_html__('En savoir plus', 'textdomain'),
                'description' => esc_html__('Texte du bouton', 'textdomain'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'condition' => [
                    'text_image_enable_download' => 'yes',
                ],
            ]
        );
    ...
    protected function render(): void
    {
        ...
        require __DIR__ . '/text-image-template.php';
    }
}

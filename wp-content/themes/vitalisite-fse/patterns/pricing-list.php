<?php
/**
 * Title: Tarifs (Détaillé)
 * Slug: vitalisite-fse/pricing-list
 * Description: Section tarifs avec cartes pleine largeur, idéale pour les praticiens ayant besoin de rédiger des descriptions longues.
...
<section class="wp-block-group vitalisite-pricing-section vitalisite-section">
    ...
    <div class="wp-block-vitalisite-fse-pricing-list vitalisite-pricing-list reveal-stagger">
        ...
        <!-- wp:vitalisite-fse/pricing-item {"title":"Consultation d'urgence (Dimanche \u0026 Lundi)","description":"Créneaux réservés exclusivement aux urgences douloureuses aiguës (blocages, lumbagos, torticolis sévères...). Intervention rapide pour soulager la crise. Une majoration est appliquée pour les jours fériés et les dimanches conformément à la législation en vigueur.","price":"100€"} /-->
    </div>
    <!-- /wp:vitalisite-fse/pricing-list -->

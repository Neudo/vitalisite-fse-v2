...
<section class="wp-block-group alignfull vitalisite-section full-section vitalisite-hero-cover-wrapper" style="padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50);padding-left:20px;padding-right:20px">
    ...
    <!-- wp:cover {"tagName":"div","dimRatio":35,"minHeight":60,"minHeightUnit":"vh","className":"vitalisite-hero-cover reveal-parallax","style":{"spacing":{"padding":{"top":"var:preset|spacing|70","bottom":"var:preset|spacing|70"}},"border":{"radius":"var:preset|custom|image-radius"}},"layout":{"type":"constrained"}} -->
    <div class="wp-block-cover vitalisite-hero-cover reveal-parallax" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70);min-height:60vh;border-radius:var(--wp--preset--custom--image-radius)">
        ...
        <div class="wp-block-cover__inner-container">
            ...
            <div class="wp-block-group vitalisite-hero-cover__content">
                ...
                <!-- wp:heading {"level":1,"className":"reveal-y","style":{"typography":{"fontWeight":"700","lineHeight":"1.1"}}} -->
                <h1 class="wp-block-heading reveal-y" style="font-weight:700;line-height:1.1">Titre principal de la section</h1>
                <!-- /wp:heading -->

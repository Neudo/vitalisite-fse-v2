...
<section class="wp-block-group vitalisite-carrousel-section vitalisite-section">
	...
	<h2 class="wp-block-heading has-text-align-center vitalisite-carrousel__title reveal-y">Lorem ipsum dolor sit amet</h2>
	<!-- /wp:heading -->

	<!-- wp:paragraph {"align":"center","className":"vitalisite-carrousel__description reveal-y"} -->
	<p class="has-text-align-center vitalisite-carrousel__description reveal-y">Consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
	<!-- /wp:paragraph -->
